...
public sealed class OpdsFeed
{
    ...
    /// </summary>
    public Dictionary<string, object> ExtendedFeedMetadata { get; set; } = new(StringComparer.OrdinalIgnoreCase);
...
public sealed class OpdsEntry
{
    ...
    /// </summary>
    public Dictionary<string, object> ExtendedMetadata { get; set; } = new(StringComparer.OrdinalIgnoreCase);
}
