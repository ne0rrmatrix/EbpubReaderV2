(() => {
    ...
    const OPF_PATH = "The Arrears Queue - James Crutchley/OEBPS/content.opf";
    ...
    function getEffectiveSettings() {
        ...
        return {
            ...state.settings,
            columnCount: canUseTwoColumns ? "2" : "1"
        };
    }
    ...
    function applySettingsToFrame(frameDocument) {
        ...
        const theme = {
            paper: { background: "#ffffff", text: "#202020", link: "#075985" },
            sepia: { background: "#f6f1e8", text: "#2c241b", link: "#7c3f00" },
            night: { background: "#1c2430", text: "#e9edf2", link: "#8bd7ff" }
        }[settings.theme];
        const fontFamily = {
