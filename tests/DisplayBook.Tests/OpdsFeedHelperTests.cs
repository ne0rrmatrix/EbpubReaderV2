...
{
	static Link MakeLink(string? rel, string href = "http://calibre.local:8080/x") => new() { Rel = rel, Href = href };
	...
	{
		OpdsFeed feed = new() { Links = [MakeLink(Link.RelSelf)] };
